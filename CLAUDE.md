...
- `/mobile-keys/<id>/toggle-key-code` (POST) — flips the per-row `key_code` checkbox in the "Key Code" column (between Ordered and Complete). Same checkbox style; does not tint the row.
